...
parser.add_argument('--wham_dir', type=str, required=True,
                    help='Path to DEMAND noise root directory')
parser.add_argument('--orig_num_samples', type=int, default=20000,
                    help='Number of original samples')
